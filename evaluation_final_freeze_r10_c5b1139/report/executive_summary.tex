...
\pagestyle{empty}
\begin{document}
\section*{Smart-MDT Executive Evaluation Summary}
\textbf{Input:} rust\_results\_final\_freeze\_r10\_1fbfa30 (7360 rows,
46 datasets).
...
Accuracy & CALS-MDT &
0.864820 \\
Smallest tree & CompactExplain &
11.124 nodes \\
Fastest runtime & Unary &
0.047 s \\
Shortest AXp & CompactExplain &
2.721 \\
\bottomrule
\end{tabular}
\end{center}

\subsection*{Key statistical conclusions}
\begin{itemize}
...
Repeated runs and depths are averaged within each dataset. Tests are paired
over independent dataset blocks. Confidence intervals use
...
a distributional reference, which is not a paired estimator.
\end{document}
